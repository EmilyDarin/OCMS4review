...
## Nitrogen analyses, by station {.tabset .tabset-pills}
...
column(12, 
  ...
  column(4, 
       selectInput('varsel', 'Select constituent:', choices = unique(pows$sta))
  )
)
```
...
p <- ggplot(pows, aes(x = eff, y = chg, z = pow)) + 
  # geom_tile() +
