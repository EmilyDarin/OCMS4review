...
column(12, 
       column(4,
         selectInput('consel', 'Select constituent type:', choices = list('Metals' =  'metals', 'Nutrients' = 'nutrs', 'Organic' = 'organs'), selected = 'Nutrients') 
       ),
       column(4, 
...
column(12, 
  ...
  column(4, 
       selectInput('varsel', 'Select constituent:', choices = nutrs, selected = 'Nitrate, Nitrite')
  )
)
```
