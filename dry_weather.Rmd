...
column(12,
       ...
       column(8,
              renderUI({
                ...
                sliderInput('thrsel2', 'Select threshold:', min = val[1], max = val[2], value = qntval[6], width = '600px')
...
Map shows number of exceedances of each station above the selected value across all dates/stations for `r renderText({input$varsel3})` (`r renderText({round(input$thrsel2, 1)})`)
```{r}
