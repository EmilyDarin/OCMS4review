...
Hotspots show exceedances relative to regulatory thresholds for each constituent.  Median values are applied in the absence of a threshold, which applies only to TKN, TP, and TN.
...
column(12,
       ...
       column(4, 
              renderText({
                ...
                if(length(varthr) != 0)
                  out <- paste0(txt, ', default selection is regulatory threshold')
