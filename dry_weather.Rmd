...
Hotspots show exceedances relative to thresholds for each constituent.  Median values are applied in the absence of a threshold, which applies only to TKN, TP, and TN.
