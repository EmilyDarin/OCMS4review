...
#   out <- paste0("Optimal sample effort in ", smpsel, " weather at ", powsel, " power: ", medv , ' relative effort')
#   
#   return(out)
#   
# })
...
#   opts <- optdat2$opts
#   medv <- median(opts$eff, na.rm = T) %>% round(2)
#   out <- paste0("Optimal sample effort in ", smpsel, ' weather at ', powsel2, " power: ", medv , ' relative effort')
#   
#   return(out)
#   
# })
